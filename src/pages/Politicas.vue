...
<p>A sua privacidade é importante para nós. É política do App Notation respeitar a sua privacidade em relação a
    qualquer informação sua que possamos coletar no site <a href=https://appnotation.vercel.app/>App Notation</a>, e
...
<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o App Notation oferece no site e
...
<ul>
    ...
    <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a
        ...
        humanos;</li>
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do App Notation, de seus
