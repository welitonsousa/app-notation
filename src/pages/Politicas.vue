...
<p>A sua privacidade é importante para nós. É política do {{appName}} respeita a sua privacidade em relação a
    qualquer informação sua que possamos coletar no {{appName}}, e
...
<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o {{appName}} oferece no site e
...
<ul>
    ...
    <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a
        ...
        humanos;</li>
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do {{appName}}, de seus
...
export default class Todos extends Vue {
  appName = this.$route.query.app || "App Notation"
